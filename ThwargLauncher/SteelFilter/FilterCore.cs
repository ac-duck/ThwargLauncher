...
namespace SteelFilter
{
    ...
    public class FilterCore : FilterBase
    {
        ...
        private SteelFilterCommandExecutor SteelFilterCommandExecutor;
        private SteelFilterCommandParser SteelFilterCommandParser;
        ...
        private void LogStartup()
        {
            ...
            log.WriteInfo(
                "SteelFilter.Startup, AssemblyVer: {0}, AssemblyFileVer: {1}",
        ...
        void FilterCore_CommandLineText(object sender, ChatParserInterceptEventArgs e)
        {
            try
            {
                ...
                SteelFilterCommandParser.FilterCore_CommandLineText(sender, e);
            }
            catch (Exception ex) { Debug.LogException(ex); }
        }
    }
