...
namespace SteelFilter
{
    public class LaunchControl
    {
        ...
        public class SteelFilterInfo
        {
            public string SteelFilterPath;
            public string SteelFilterVersion;
        }
        /// <summary>
        /// Called by SteelBotLauncher
        /// </summary>
        /// <returns></returns>
        public static SteelFilterInfo GetSteelFilterInfo()
        {
            var info = new SteelFilterInfo();
            var assembly = System.Reflection.Assembly.GetExecutingAssembly();
            info.SteelFilterVersion = assembly.GetName().Version.ToString();
            info.SteelFilterPath = assembly.Location;
            return info;
        }
        /// <summary>
        /// Called by SteelBotLauncher
        ...
        internal static void RecordLaunchResponse(DateTime timestampUtc)
        {
            ...
            using (var file = new StreamWriter(filepath, append: false))
            {
                ...
                file.WriteLine("SteelFilterVersion:{0}", System.Reflection.Assembly.GetExecutingAssembly().GetName().Version);
            }
        }
        /// <summary>
        /// Called by SteelBotLauncher
        ...
        public static LaunchResponse GetLaunchResponse(string ServerName, string AccountName, TimeSpan maxLatency)
        {
            ...
            try
            {
                ...
                info.SteelFilterVersion = SettingHelpers.GetSingleStringValue(settings, "SteelFilterVersion");
        ...
        private static string RecordHeartbeatStatusToString(HeartbeatGameStatus status)
        {
            using (var stream = new StringWriter())
            {
                ...
                var assembly = System.Reflection.Assembly.GetExecutingAssembly();
                stream.WriteLine("SteelFilterVersion:{0}", assembly.GetName().Version);
                stream.WriteLine("SteelFilterFilePath:{0}", assembly.Location);
        ...
        public static HeartbeatResponse GetHeartbeatStatus(string filepath)
        {
            ...
            try
            {
                ...
                info.Status.SteelFilterVersion = SettingHelpers.GetSingleStringValue(settings, "SteelFilterVersion");
                info.Status.SteelFilterFilePath = SettingHelpers.GetSingleStringValue(settings, "SteelFilterFilePath");
