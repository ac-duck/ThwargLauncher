...
namespace SteelFilter
{
    ...
    {
        internal static string FilterName = "SteelFilter";
        ...
        /// <summary>
        /// Launch file contains instructions (character) name from SteelBotLauncher.exe for SteelFilter.dll
        /// </summary>
        ...
        /// <summary>
        /// Launch response file contains pid of game, given by SteelFilter.dll to SteelBotLauncher.exe
        /// </summary>
        ...
        public static string AppFolder
        {
            get
            {
                string folderpath = System.IO.Path.Combine(AppBaseFolder, "SteelBotLauncher");
                return folderpath;
            }
        }
