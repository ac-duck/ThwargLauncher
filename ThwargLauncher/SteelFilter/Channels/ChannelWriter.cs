...
namespace SteelFilter.Channels
{
    ...
    /// For commands passed between SteelBotLauncher application and the SteelFilter dll inside the game
    /// This code is called both from SteelFilter inside the game
    /// And from the SteelBotLauncher application (which loads its own copy of SteelFilter inside itself)
    /// </summary>
