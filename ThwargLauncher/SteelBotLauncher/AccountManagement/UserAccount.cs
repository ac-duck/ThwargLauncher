    ...
    public class UserAccount : INotifyPropertyChanged
    {
        ...
        private void InitializeMe(SteelFilter.CharacterBook characterBook)
        {
            foreach (var serverItem in ServerManager.ServerList)
            {
                ...
                SteelFilter.ServerCharacterListByAccount charlist = null;
                ...
                LoadCharacterListFromSteelFilterData(server, charlist);
                if (charlist != null)
                {
        ...
        public void LoadCharacterListFromSteelFilterData(Server server, SteelFilter.ServerCharacterListByAccount charlist)
        {
            ...
            if (charlist != null)
            {
                List<SteelFilter.Character> filterChars = charlist.CharacterList;
                if (filterChars != null)
                {
        ...
        /// </summary>
        public void LoadAllProperties(SteelFilter.CharacterBook characterBook, Dictionary<string, string> properties)
        {
