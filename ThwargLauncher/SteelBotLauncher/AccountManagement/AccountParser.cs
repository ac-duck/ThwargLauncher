...
namespace SteelBotLauncher
{
    class AccountParser
    {
        ...
        {
            var charBook = SteelFilter.CharacterBook.ReadCharacters();
        ...
        private List<UserAccount> ReadAccounts(SteelFilter.CharacterBook characterMgr, string accountFilepath)
        {
            var acctList = new List<UserAccount>();
        ...
        private List<UserAccount> ReadOldUserNames(SteelFilter.CharacterBook charBook, string oldUsersFilePath)
        {
            var acctList = new List<UserAccount>();
