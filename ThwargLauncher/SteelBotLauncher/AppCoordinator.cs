    ...
    class AppCoordinator
    {
        ...
        private void MigrateSettingsIfNeeded()
        {
            ...
            catch (Exception exc)
            {
                ...
                System.Windows.MessageBox.Show("User settings failed to upgrade. Please run SteelBotLauncher again.",
        ...
        private void DeleteAllOurUserConfigs()
        {
            ...
            DeleteDirectory(localData, "SteelBotLauncher");
        ...
        {
            string filepath = System.IO.Path.Combine(SteelFilter.FileLocations.AppLogsFolder, "SteelBotLauncher-%PID%_log.txt");
            filepath = SteelFilter.FileLocations.ExpandFilepath(filepath);
            SteelFilter.FileLocations.CreateAnyNeededFoldersOfFile(filepath);
            return filepath;
        }
